...
<head>
	...
	<meta http-equiv="X-UA-Compatible" content="ie=edge">
	  <link href="Bags-mens-style.css?v=<?php echo time(); ?>" rel="stylesheet" type="text/css">
...
<body>
	...
	<h2 class="title"><a href="Bags-mens all.php">Bags & Shoes</a><span class="sub-head"> Men's Footwear</span></h2>
		<div class="filter">
			<ul>
				<li class="list active" data-filter="All"><a href="Bags-mens all.php">All</a></li>
				<li class="list" data-filter="Flipflop"><a href="Bags-mens-flipflop.php">Flip Flops</a></li>
				<li class="list" data-filter="Sandals"><a href="Bags-mens-sandals.php">Sandals</a></li>
				<li class="list" data-filter="Boots"><a href="Bags-mens-boots.php">Boots</a></li>
			</ul>
		</div>
		<div class="row">
			<?php 
			$sql="select * from bmflipflop";
			$res=$con->query($sql);
			if($res->num_rows>0)
			{
   ...
   <div class="col-1">
     ...
     <img src="flip flops/'. $row['PIC'] .'" alt="" class="img-responsive" >
     <p><strong><a href="view flipflop.php?id='. $row['PID'] .'" class="btn btn-success">'. $row['PNAME'] .'</a></strong></p>
  ...
  crossorigin="anonymous"></script>
	<script src="Bags-mens-javascript.js" type="text/javascript"></script>
</body>
</html>
