...
<html lang="en">
<head>
  <title>All-Stores Vouchers</title>
  <meta charset="utf-8">
...
<div class="small-container">
  <div class="row">
			...
			$sql="select * from gvall where PID='{$_GET["id"]}'";
			$res=$con->query($sql);
			if($res->num_rows>0)
			{
   ...
   <table class="table">
     <tr>
	 <td><img src="Vouchers/'. $row['PIC'] .'" alt="" class="large" ></td>
	 <td>
   ...
   <div class="col-1">
     ...
     <p><strong><a href="view vouchers.php?id='. $row['PID'] .'">'. $row['PNAME'] .'</a></strong></p>
