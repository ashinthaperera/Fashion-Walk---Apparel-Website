...
<div class="small-container">
  <div class="row">
			...
			$sql="select * from bwflats where PID='{$_GET["id"]}'";
			$res=$con->query($sql);
			if($res->num_rows>0)
			{
   ...
   <table class="table">
     <tr>
	 <td><img src="Flats/'. $row['PIC'] .'" alt="" class="large" ></td>
	 <td>
   ...
   ';
	...
	<div class="row">
			...
			echo  '
   <div class="col-1">
     <img src="Flats/'. $row['PIC'] .'" alt="" class="img-responsive" >
     <p><strong><a href="view flats.php?id='. $row['PID'] .'">'. $row['PNAME'] .'</a></strong></p>
