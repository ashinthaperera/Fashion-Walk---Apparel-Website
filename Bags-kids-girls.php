...
<head>
	...
	<meta http-equiv="X-UA-Compatible" content="ie=edge">
	  <link href="Bags-kids-style.css?v=<?php echo time(); ?>" rel="stylesheet" type="text/css">
...
<body>
	...
	<h2 class="title"><a href="Bags-kids all.php">Bags & Shoes</a><span class="sub-head"> Kid's Footwear</span></h2>
		<div class="filter">
			<ul>
				<li class="list active" data-filter="All"><a href="Bags-kids all.php">All</a></li>
				<li class="list" data-filter="sandals"><a href="Bags-kids-sandals.php">Sandals</a></li>
				<li class="list" data-filter="girls"><a href="Bags-kids-girls.php">Girls</a></li>
			</ul>
		</div>
		<div class="row">
			<?php 
			$sql="select * from bkgirls";
			$res=$con->query($sql);
			if($res->num_rows>0)
			{
   ...
   <div class="col-1">
     ...
     <img src="girls/'. $row['PIC'] .'" alt="" class="img-responsive" >
     <p><strong><a href="view girls.php?id='. $row['PID'] .'" class="btn btn-success">'. $row['PNAME'] .'</a></strong></p>
  ...
  crossorigin="anonymous"></script>
	<script src="Bags-kids-javascript.js" type="text/javascript"></script>
</body>
</html>
