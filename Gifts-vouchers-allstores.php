...
<head>
	...
	<meta http-equiv="X-UA-Compatible" content="ie=edge">
	  <link href="Gifts-vouchers-style.css?v=<?php echo time(); ?>" rel="stylesheet" type="text/css">
...
<body>
	...
	<h2 class="title"><a href="Gifts-vouchers all.php">GIFTS & VOUCHERS</a><span class="sub-head"> Gift Vouchers</span></h2>
		<div class="filter">
			<ul>
				<li class="list active" data-filter="All"><a href="Gifts-vouchers all.php">All</a></li>
				<li class="list" data-filter="Casual"><a href="Gifts-vouchers-allstores.php">All Stores</a></li>
			</ul>
		</div>
		<div class="row">
			<?php 
			$sql="select * from gvall";
			$res=$con->query($sql);
			if($res->num_rows>0)
			{
   ...
   <div class="col-1">
     ...
     <img src="Vouchers/'. $row['PIC'] .'" alt="" class="img-responsive" >
     <p><strong><a href="view vouchers.php?id='. $row['PID'] .'" class="btn btn-success">'. $row['PNAME'] .'</a></strong></p>
  ...
  crossorigin="anonymous"></script>
	<script src="Gifts-vouchers-javascript.js" type="text/javascript"></script>
</body>
</html>
