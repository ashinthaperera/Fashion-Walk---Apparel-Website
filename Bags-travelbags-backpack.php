...
<head>
	...
	<meta http-equiv="X-UA-Compatible" content="ie=edge">
	  <link href="Bags-travelbags-style.css?v=<?php echo time(); ?>" rel="stylesheet" type="text/css">
...
<body>
	...
	<h2 class="title"><a href="Bags-travelbags all.php">Bags & Shoes</a><span class="sub-head"> Travel Bags</span></h2>
		<div class="filter">
			<ul>
				<li class="list active" data-filter="All"><a href="Bags-travelbags all.php">All</a></li>
				<li class="list" data-filter="All"><a href="Bags-travelbags-backpack.php">Backpack</a></li>
				<li class="list" data-filter="All"><a href="Bags-travelbags-shoulderbags.php">Shoulder Bags</a></li>
			</ul>
		</div>
		<div class="row">
			<?php 
			$sql="select * from btbackpack";
			$res=$con->query($sql);
			if($res->num_rows>0)
			{
   ...
   <div class="col-1">
     ...
     <img src="backpacks/'. $row['PIC'] .'" alt="" class="img-responsive" >
     <p><strong><a href="view backpack.php?id='. $row['PID'] .'" class="btn btn-success">'. $row['PNAME'] .'</a></strong></p>
