...
<head>
	...
	<meta http-equiv="X-UA-Compatible" content="ie=edge">
	  <link href="Gifts-cards-style.css?v=<?php echo time(); ?>" rel="stylesheet" type="text/css">
	  <link href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css" rel="stylesheet">
	  <link rel="shortcut icon" type="image/jpg" href="../../../img/correctedlogo.png">
	<title>Gifts | Fashion Walk</title>
	</head>
<body>
	...
	<h2 class="title"><a href="Gifts-cards all.php">GIFTS & VOUCHERS</a><span class="sub-head"> Cards</span></h2>
		<div class="filter">
			<ul>
				<li class="list active" data-filter="All"><a href="Gifts-cards all.php">All</a></li>
				<li class="list" data-filter="Casual"><a href="Gifts-cards-cardboxes.php">Card Boxes</a></li>
				<li class="list" data-filter="All"><a href="Gifts-cards-birthday.php">Birthday</a></li>
				<li class="list" data-filter="All"><a href="Gifts-cards-wedding.php">Wedding</a></li>
				<li class="list" data-filter="All"><a href="Gifts-cards-love.php">Love</a></li>
				<li class="list" data-filter="All"><a href="Gifts-cards-christmas.php">Christmas</a></li>
				<li class="list" data-filter="All"><a href="Gifts-cards-newyear.php">New Year</a></li>
			</ul>
		</div>
		<div class="row">
			<?php 
			$sql="select * from gcchristmas";
			$res=$con->query($sql);
			if($res->num_rows>0)
			{
   ...
   <div class="col-1">
     ...
     <img src="christmas/'. $row['PIC'] .'" alt="" class="img-responsive" >
     <p><strong><a href="view christmas.php?id='. $row['PID'] .'" class="btn btn-success">'. $row['PNAME'] .'</a></strong></p>
  ...
  crossorigin="anonymous"></script>
	<script src="Gifts-cards-javascript.js" type="text/javascript"></script>
</body>
</html>
