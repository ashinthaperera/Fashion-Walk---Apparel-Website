...
<head>
	...
	<meta http-equiv="X-UA-Compatible" content="ie=edge">
	  <link href="Bags-sports-style.css?v=<?php echo time(); ?>" rel="stylesheet" type="text/css">
...
<body>
	...
	<h2 class="title"><a href="Bags-sports all.php">Bags & Shoes</a><span class="sub-head"> Sports's Footwear</span></h2>
		<div class="filter">
			<ul>
				<li class="list active" data-filter="All"><a href="Bags-sports all.php">All</a></li>
				<li class="list" data-filter="All"><a href="Bags-sports-unisex.php">Unisex</a></li>
			</ul>
		</div>
		<div class="row">
			<?php 
			$sql="select * from bsunisex";
			$res=$con->query($sql);
			if($res->num_rows>0)
			{
   ...
   <div class="col-1">
     ...
     <img src="unisex/'. $row['PIC'] .'" alt="" class="img-responsive" >
     <p><a href="view unisex.php?id='. $row['PID'] .'" class="btn btn-success"><strong>'. $row['PNAME'] .'</a></strong></p>
...
<script src="Bags-sports-javascript.js" type="text/javascript"></script>
</body>
</html>
