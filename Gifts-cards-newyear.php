...
<body>
   ...
   <div class="col-1">
     ...
     <img src="New year/'. $row['PIC'] .'" alt="" class="img-responsive" >
     <p><strong><a href="view newyear.php?id='. $row['PID'] .'" class="btn btn-success">'. $row['PNAME'] .'</a></strong></p>
